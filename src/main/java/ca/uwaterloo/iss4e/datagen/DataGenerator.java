package ca.uwaterloo.iss4e.datagen;
...
public class DataGenerator {
    ...
    public static void main(String[] args) {
        String usage = "java ca.uwaterloo.iss4e.datagen.DataPreparator parallelism activityReadingSeedInputPath temperatureSeedInputPath outputPath startDate nDays numberOfTimeseries peakyRatio";
        if (args.length != 8) {
